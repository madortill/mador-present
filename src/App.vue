<template>
  <div id="app">
    <div class="header">
      <img class="til" src="/src/assets/general/til.svg" alt="til" />
      <img
        class="mifkada"
...
export default {
  ...
  methods: {
    toField(event) {
      ...
      this.title = this.fieldData[event.target.id].title;
...
@font-face {
  font-family: aharoni;
  src: url("/src/assets/fonts/._aharoniclm-bold-webfont.ttf");
}
